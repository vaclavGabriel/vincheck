					...
					<article className="mt-5 pt-4 border-top">
						<div className="row justify-content-center">
							<div className="col-lg-10">
								<h2 className="mb-4">Vše o kontrole VIN kódu a historii vozidla</h2>

								<section className="mb-5">
									<h3 className="h4">Co je to VIN kód?</h3>
									<p>
										<strong>VIN (Vehicle Identification Number)</strong> je unikátní 17místný alfanumerický kód,
										který slouží jako "rodné číslo" každého vyrobeného vozidla. Tento mezinárodní standard (ISO 3779)
										zaručuje, že žádná dvě vozidla na světě (vyrobená za posledních 30 let) nemají stejný identifikátor.
									</p>
									<p>
										VIN kód obsahuje zakódované informace o výrobci, modelu, roce výroby, místě výroby,
										motorizaci a výbavě. Je nezbytný pro identifikaci vozidla při koupi, prodeji, servisu,
								...
								<section className="mb-5">
									...
									<p>
										VIN kód je na vozidle umístěn na několika místech, aby bylo ztíženo jeho padělání.
										Nejčastěji ho naleznete:
									</p>
									<ul>
										<li><strong>Pod čelním sklem</strong> - na straně řidiče, viditelné zvenčí.</li>
										<li><strong>V motorovém prostoru</strong> - vyražený na karoserii nebo na výrobním štítku.</li>
										<li><strong>Na B-sloupku</strong> - na štítku u dveří řidiče nebo spolujezdce.</li>
										<li><strong>Pod podlahou</strong> - často u sedadla spolujezdce.</li>
										<li><strong>V dokladech</strong> - v malém i velkém technickém průkazu (řádek E) a v zelené kartě.</li>
									</ul>
								</section>
								...
								<section className="mb-5">
									...
									<p>
										Kontrola VIN kódu v registru vozidel vám poskytne ověřená data přímo od Ministerstva dopravy ČR.
										Tato data jsou klíčová zejména při nákupu ojetého vozu. Zjistíte například:
									</p>
									<ul>
										<li>Zda technické údaje v inzerátu odpovídají skutečnosti (výkon, objem, palivo).</li>
										<li>Skutečné datum první registrace (stáří vozidla).</li>
										<li>Platnost technické prohlídky (STK) - vyhnete se nákupu vozu bez platné STK.</li>
										<li>Počet míst k sezení, barvu a další parametry.</li>
									</ul>
									<p>
										Tato bezplatná kontrola je prvním krokem. Pokud základní údaje nesedí, může to být signál,
										že s vozidlem není něco v pořádku (např. vyměněný motor, přelakovaná karoserie,
										chyby v dokladech).
									</p>
								</section>
								...
								<section className="mb-5">
									...
									<p>
										Centrální registr silničních vozidel (CRV) je informační systém veřejné správy vedený
										Ministerstvem dopravy ČR. Obsahuje údaje o všech vozidlech registrovaných v České republice.
										Naše služba využívá oficiální data z tohoto registru (prostřednictvím otevřených dat),
										takže máte jistotu, že informace jsou aktuální a přesné.
									</p>
									<p>
										V registru jsou evidovány osobní automobily, motocykly, nákladní vozy, autobusy,
										přípojná vozidla i traktory. Pokud vozidlo bylo dovezeno ze zahraničí a ještě nemá
										české doklady, v tomto registru ho nenajdete.
									</p>
								</section>
								...
								<section className="mb-5">
									...
									<p>
										Ano, kontrola základních technických údajů z registru vozidel je na VIN Info.cz zcela zdarma.
										Neplatíte žádné poplatky za zobrazení dat o motoru, karoserii, STK a registraci.
									</p>

									<h4 className="h6 mt-3">Zobrazí se i historie najetých kilometrů?</h4>
									<p>
										Základní registr vozidel obsahuje technické údaje, ale nikoliv historii nájezdu kilometrů
										z STK. Pro kontrolu tachometru doporučujeme využít specializované placené služby nebo
										stránky Ministerstva dopravy (kontrolatachometru.cz), kde je však potřeba znát i číslo
										protokolu poslední STK.
									</p>

									<h4 className="h6 mt-3">Mohu zjistit majitele vozidla?</h4>
									<p>
										Ne. Z důvodu ochrany osobních údajů není možné veřejně zjistit jméno ani adresu
										vlastníka nebo provozovatele vozidla. Registr poskytuje pouze technická data o vozidle,
