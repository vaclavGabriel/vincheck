		...
		<>
			...
			<main className="container mt-5">
				...
				<div className="alert alert-warning" role="alert">
					<strong>Důležité:</strong> Před koupí ojetého vozidla je nezbytné prověřit
					jeho kompletní historii. Zjistěte všechny důležité informace o vozidle,
				...
				<article>
					<section className="mt-4 mb-5">
						...
						<ul>
							...
							<li>
								<strong>Servisní historie</strong> - jak bylo vozidlo
								udržováno a servisováno
							</li>
							<li>
							...
							<li>
								<strong>Zastavení vozidla</strong> - zda není vozidlo
								zastavené nebo v exekuci
							</li>
							<li>
								<strong>Kontrola najetých kilometrů</strong> - zda nebyl
								najetý počet kilometrů upravován
							</li>
							<li>
					...
					<section className="mt-5 mb-5">
						...
						<h3 className="mt-4 mb-3">3. Počet majitelů a historie vlastnictví</h3>
						<p>
						...
						<p>
							...
							nového majitele, dokud není závazek uhrazen. Před koupí vozidla
							je nezbytné prověřit, zda není vozidlo zastavené nebo v exekuci.
						</p>
						...
						<p>
							...
							historie vozu může odhalit nesrovnalosti v najetých kilometrech
							na základě servisních záznamů a kontrol STK.
						</p>
					</section>
					...
					<section className="mt-5 mb-5">
						...
						<p>
							Kompletní historii vozu byste měli prověřit vždy před koupí ojetého
							vozidla. Zejména v těchto případech:
						</p>
						<ul>
							<li>
							...
							<li>
								<strong>Při podezření na upravené kilometry</strong> - pokud
								se vám zdá, že najeté kilometry neodpovídají stavu vozidla
							</li>
							<li>
					...
					<section className="mt-5 mb-5">
						...
						<p>
							Po prověření historie vozidla byste měli:
						</p>
						<ol>
							<li>
							...
							<li>
								<strong>Vyjednat cenu</strong> - na základě zjištěných
								informací můžete vyjednat cenu vozidla
							</li>
							<li>
